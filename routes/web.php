...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::get('/transactions/checkout', Checkout::class)->name('transactions.checkout');
    Route::get('/transactions/print/invoice', [TransactionController::class, 'print_invoice'])->name('transactions.print.invoice');
    // Route::get('/transactions/invoice', [TransactionController::class, 'print_invoice'])->name('transactions.print.invoice');
    // Route::view('/transactions/invoice', 'transactions.invoice')->name('transactions.invoice');
