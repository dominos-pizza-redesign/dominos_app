<div x-data="{ shownPaymentDetailModal: false, timeout: null }">
    <template x-teleport="body">
        <div x-init="@this.on('success', () => {
            clearTimeout(timeout);
            shownPaymentDetailModal = true;
            console.log(shownPaymentDetailModal);
            timeout = setTimeout(() => { shownPaymentDetailModal = false }, 4000);
            ...
            class="fixed bottom-0 z-50 h-screen w-screen bg-sky-600 pt-3 pb-5 transition"
